...
export const Header = () => {
    return (
        <div
            className='relative h-[70vh] w-full my-8 bg-cover bg-center bg-no-repeat rounded-2xl overflow-hidden xl:bg-top'
        ...
        >
            <div className="absolute flex flex-col items-start gap-3 sm:gap-4 w-4/5 sm:max-w-6/10 md:max-w-5/10 bottom-1/10 sm:bottom-15/100 left-5/100 sm:left-1/10 p-4 bg-black/20 rounded-2xl text-white">
                ...
                <a
                    className="mt-4 px-6 py-3 bg-gray-400 text-primary rounded-lg font-medium cursor-pointer hover:bg-blue-700 transition-colors shadow-md"
